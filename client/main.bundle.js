...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.onSubmit = function () {
        var _this = this;
        this.http.post('/auth/login', { name: this.name, password: this.password }).toPromise().then(function (res) {
            var token = _this.retrieveToken(res);
            if (token) {
                _this.token = token;
            }
        });
    ...
    AppComponent.prototype.onRefresh = function () {
        ...
        this.http.get('/auth/refresh', options).toPromise().then(function (res) {
            var token = _this.retrieveToken(res);
            if (token) {
                _this.token = token;
            }
    ...
    AppComponent.prototype.onNoToken = function () {
        this.http.get('/auth/refresh').toPromise().then(function (res) {
            console.log(res);
        });
    };
    ...
    AppComponent.prototype.retrieveToken = function (response) {
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["E" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_3__angular_common__["c" /* Location */], { provide: __WEBPACK_IMPORTED_MODULE_3__angular_common__["d" /* LocationStrategy */], useClass: __WEBPACK_IMPORTED_MODULE_3__angular_common__["e" /* PathLocationStrategy */] }],
